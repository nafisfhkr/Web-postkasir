    ...
    <form action="{{ route('diskon.update', $diskon) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="nama_diskon" id="nama_diskon" class="form-control" 
                   value="{{ $diskon->nama_diskon }}" required>
        </div>
        <div class="mb-3">
            <label for="besar_diskon" class="form-label">Besar Diskon (%)</label>
            <input type="number" name="besar_diskon" id="besar_diskon" class="form-control" 
                   value="{{ $diskon->besar_diskon }}" required min="0" max="100">
        </div>
        <div class="mb-3">
            ...
            <input type="number" name="jangka_waktu" id="jangka_waktu" class="form-control" 
                   value="{{ $diskon->jangka_waktu }}" required min="1">
        </div>
